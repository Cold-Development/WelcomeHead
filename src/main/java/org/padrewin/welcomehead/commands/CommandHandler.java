...
public abstract class CommandHandler implements TabExecutor, NamedExecutor {
     ...
     */
    public CommandHandler(WelcomeHead plugin, String cmd, CommandManager.CommandAliases aliases) {
        this.plugin = plugin;
        this.cmd = cmd;
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        try {
            ...
            sender.sendMessage(ChatColor.RED + "A WelcomeHead error occurred while executing that command. Did you enter an invalid parameter?");
        }
